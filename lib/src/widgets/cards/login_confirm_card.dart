...
class _ConfirmLoginCard extends StatefulWidget {
  const _ConfirmLoginCard({
    Key? key,
  ...
  @override
  _ConfirmLoginCardState createState() => _ConfirmLoginCardState();
}

class _ConfirmLoginCardState extends State<_ConfirmLoginCard>
